...
<body id="page-top">
    ...
    <div class="card-header">
            <h6 class="m-0 font-weight-bold text-dark">Edit Data Masyarakat</h6>
          </div>
        <div class="card-body">
            ...
            ?>
                <form action="update_masyarakat.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group cols-sm-6">
                        ...
                        <input type="text" name="nama" value="<?php echo $_SESSION['user_name']; ?>" class="form-control">
                    </div>
                    <div class="form-group cols-sm-6">
                        <label style="color:black">Username</label>
                        <input type="text" name="user_name" value="<?php echo $_SESSION['nama']; ?>" class="form-control">
                    </div>
                    ...
                    <div class="form-group cols-sm-6">
                        <label style="color:black">Telp</label>
