            ...
            <a href="admin.php?url=tambah_petugas" class="btn btn-primary btn-icon-split">
              ...
              <div class="table-responsive">
                <table class="table table-bordered text-white " id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                     <th style="color:black">ID Petugas</th>
                     <th style="color:black">Nama Petugas</th>
                     <th style="color:black">Username</th>
                     <th style="color:black">Telp</th>
                  ...
                  <tbody>
                    <tr>
                    <td style="color:black"><?php echo $data['id_petugas']; ?></td>
                      <td style="color:black"><?php echo $data['nama_petugas']; ?></td>
                      <td style="color:black"><?php echo $data['user_name']; ?></td>
                      <td style="color:black"><?php echo $data['telp']; ?></td>
