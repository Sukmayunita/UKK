...
<div class="card shadow">
    ...
    <span class="text">Kembali</span>
        ...
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            <?php
            require 'koneksi.php';
            $sql=mysql_query("select * from pengaduan, tanggapan where tanggapan.id_pengaduan='$_GET[id]' and tanggapan
            ...
            ?>
            <div class="form-group cols-sm-6">
                <label style="color:black">Tanggal Tanggapan</label>
            ...
            <div class="form-group cols-sm-6">
                ...
                <input type="text" name="kategori" value="<?php echo $data['kategori']; ?>" class="form-control" readonly>
            </div>
            <div class="form-group cols-sm-6">
                <label style="color:black">Tulis Laporan</label>
               <textarea class="form-control" rows="7" name="isi_laporan" readonly=""><?php echo $data['isi_laporan'];?>
               </textarea>
            </div>

            <div class="form-group cols-sm-6">
                <label style="color:black">Tanggapan dari Petugas</label>
